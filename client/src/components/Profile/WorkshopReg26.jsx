...
const WorkshopReg26 = () => {
    ...
    const fetchRegistrations = async () => {
        ...
        try {
            ...
            const response = await axios.get(`${config.apiBaseUrl}/workshop-registrations-2026`, {
                headers: {
                    Authorization: token,
                    isAdmin: 'true'
                }
    ...
    const handleVerifyPayment = async (registrationId, currentStatus) => {
        ...
        try {
            ...
            const response = await axios.put(
                `${config.apiBaseUrl}/workshop-registrations-2026/${registrationId}/verify`, 
    ...
    const handleDeleteRegistration = async () => {
        ...
        try {
            ...
            await axios.delete(
                `${config.apiBaseUrl}/workshop-registrations-2026/${registrationToDelete._id}`,
                {
                    headers: {
                        Authorization: token,
                        isAdmin: 'true'
                ...
                if (registrations.teams && registrations.teams[teamNo]) {
                    ...
                    for (const member of teamMembers) {
                        await axios.delete(
                            `${config.apiBaseUrl}/workshop-registrations-2026/${member._id}`,
                            {
                                headers: {
                                    Authorization: token,
                                    isAdmin: 'true'
    ...
    const exportToPDF = () => {
        try {
            ...
            const workshopTitle = "Workshop Registrations 2026";
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(workbook, 'workshop-registrations-2026.xlsx');
    };
                                                                            ...
                                                                            <div className="flex flex-col">
                                                                                ...
                                                                                {teamData.teamLead.payment_screenshot && (
                                                                                    <button 
                                                                                        ...
                                                                                        onClick={(e) => { e.stopPropagation(); openImageModal(teamData.teamLead.payment_screenshot); }}
                                                                                    >
                                                            ...
                                                            <div className="flex flex-col">
                                                                ...
                                                                {registration.payment_screenshot && (
                                                                    <button 
                                                                        type="button"
                                                                        className="mt-1 text-xs text-blue-400 hover:text-blue-300 transition-colors flex items-center gap-1"
                                                                        onClick={(e) => { e.stopPropagation(); openImageModal(registration.payment_screenshot); }}
                                                                    >
                                                                        <svg className="w-3 h-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                                                        </svg>
